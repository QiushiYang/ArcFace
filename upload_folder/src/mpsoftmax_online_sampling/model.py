    ...
    for epoch in range(begin_epoch, end_epoch):
        ...
        while True:
            ...
            for data_batch in train_data:
                ...
                batch_index = nd.empty((batch_size*num_workers,))
                ...
                for index,islice in enumerate(split_slices):
                    ...
                    total_index = nd.empty((slice_batch_size*num_workers,))
                    ...
                    if update_on_kvstore:
                        ...
                        mpi_allgather(data_batch.index[0][islice], total_index)
                    ...
                    if update_on_kvstore:
                        ...
                        total_index[worker_slice] = total_index[:]
                    else:
                        total_index[worker_slice] = data_batch.index[0][:]

                # batch callback
                train_data.provide_loss_queue.put_nowait(batch_loss)
                train_data.provide_index_queue.put_nowait(total_index)
        ...
        print('weigth prob:')
        print(train_data.weighted_prob)
